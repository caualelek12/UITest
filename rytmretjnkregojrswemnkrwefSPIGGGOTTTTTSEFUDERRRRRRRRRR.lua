        ...
        function CAT:_AddDropdown(o5, parentOverride)
            ...
            Hd.MouseButton1Click:Connect(function()
                if isOpen then
                    ...
                    openOV(function(ov)
                        buildDD(ov)
                        -- Reset state if overlay dismissed externally (click-off)
                        ov.AncestryChanged:Connect(function()
    ...
    local function buildPlayerList()
        ...
        local function mkActionBtn(parent, txt, col, cb2)
            local b = mk("TextButton",{
                ...
                BackgroundColor3=col, Text=txt, TextColor3=C.White,
                TextSize=10, Font=Enum.Font.GothamBold,
                AutoButtonColor=false, BorderSizePixel=0, Parent=parent,
            })
        ...
        local function buildCard(p)
            ...
            -- Teleport To
            mkActionBtn(actFr,"TP TO",rgb(30,60,100),function()
            ...
            -- Spectate
            mkActionBtn(actFr,"SPEC",rgb(60,30,100),function()
            ...
            -- Stick To
            mkActionBtn(actFr,"STICK",rgb(80,50,20),function()
            ...
            -- Mark Friend
            mkActionBtn(actFr,"FRIEND",rgb(20,80,40),function()
