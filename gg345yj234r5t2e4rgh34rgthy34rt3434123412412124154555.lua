...
function Peleccos:CreateWindow(o)
    ...
    local function buildSettings()
        ...
        local cfgNewBtn = mk("TextButton",{Size=dim2(0,60,1,0),Position=dim2(1,-62,0,0),
            BackgroundColor3=AC,Text="+ New",TextColor3=C.White,TextSize=10,
            Font=Enum.Font.GothamBold,AutoButtonColor=false,BorderSizePixel=0,Parent=cfgInputRow})
        mk("UICorner",{CornerRadius=dim(0,3),Parent=cfgNewBtn})
        onAC(function(c) cfgNewBtn.BackgroundColor3=c; cfgNewBtn.TextColor3=acContrast(c) end)

        local cfgListSF = mk("ScrollingFrame",{Size=dim2(1,0,1,-30),Position=dim2(0,0,0,30),
        ...
        local function refreshCfgList()
            ...
            for _,cname in ipairs(list) do
                ...
                local function smBtn2(txt,xOff,col2,cb2)
                    ...
                    mk("UICorner",{CornerRadius=dim(0,3),Parent=b})
