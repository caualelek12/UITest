...
-- Blocky: 0 px corner radius (square everything)
...
function Peleccos:CreateWindow(o)
    ...
    local function notify(opts)
        ...
        local Card = mk("Frame", {
            ...
            BorderSizePixel=1, ClipsDescendants=false, Parent=NotifHolder,
        })
    ...
    local WatermarkFrame = mk("Frame", {
        Size=dim2(0, 8, 0, 18), Position=dim2(0, 8, 0, 8),
    ...
    local WmBar = mk("Frame", {
        ...
        BackgroundColor3=AC, BorderSizePixel=0, Parent=WatermarkFrame,
    })
    onAC(function(c) WmBar.BackgroundColor3 = c end)
    local WmText = mk("TextLabel", {
        Size=dim2(1,-6,1,0), Position=dim2(0,4,0,0),
        BackgroundTransparency=1, Text="",
        TextColor3=C.Tx1, TextSize=10, Font=Enum.Font.Code,
        TextXAlignment=Enum.TextXAlignment.Left,
        AutomaticSize=Enum.AutomaticSize.X, Parent=WatermarkFrame,
    })
    ...
    local TabScroll = mk("ScrollingFrame", {
        Size=dim2(1,0,1,-144), Position=dim2(0,0,0,58),
    ...
    local function openContextPopup(opts)
        openOV(function(ov)
            ...
            -- Mode row
            local ModeRow = mk("Frame",{Size=dim2(1,-12,0,26),Position=dim2(0,6,0,8),
            ...
            refreshModes()
            -- Keybind row
            local KbRow = mk("Frame",{Size=dim2(1,-12,0,24),Position=dim2(0,6,0,40),
                BackgroundTransparency=1,ZIndex=251,Parent=Pop})
            mk("TextLabel",{Size=dim2(0,56,1,0),BackgroundTransparency=1,Text="Keybind:",
            ...
            UIS.InputBegan:Connect(function(i, gpe)
                ...
                opts.setKey(k); kbBtn.Text=keyName(k); kbBtn.TextColor3=AC; listening=false
            end)
        end)
    end
    ...
    function WO:AddCategory(name)
        ...
        -- Sidebar button
        local Btn = mk("TextButton",{Name=catKey,Size=dim2(1,0,0,30),
            BackgroundColor3=C.BgHover,BackgroundTransparency=1,
            Text="",BorderSizePixel=0,Parent=TabScroll})
        local Ind = mk("Frame",{Name="Ind",Size=dim2(0,2,0,14),Position=dim2(0,0,0.5,-7),
            BackgroundColor3=AC,BorderSizePixel=0,Visible=false,Parent=Btn})
        local Lbl = mk("TextLabel",{Name="Lbl",Size=dim2(1,-14,1,0),Position=dim2(0,10,0,0),
        ...
        Btn.MouseEnter:Connect(function()
            if catKey~=ActiveTab then tw(Btn,{BackgroundColor3=C.BgHover,BackgroundTransparency=0},0.08); Lbl.TextColor3=C.Tx1 end
        end)
        Btn.MouseLeave:Connect(function()
            if catKey~=ActiveTab then tw(Btn,{BackgroundTransparency=1},0.08); Lbl.TextColor3=C.Tx2 end
        end)
        ...
        function CAT:_AddToggle(o5, parentOverride)
            ...
            local Lbl = mk("TextLabel",{Size=dim2(1,-34,1,0),BackgroundTransparency=1,Text=nm,
                TextColor3=val and C.Tx0 or C.Tx1,TextSize=11,Font=MenuFont,
                TextXAlignment=Enum.TextXAlignment.Left,Parent=row})
            onFont(function(mf,_) Lbl.Font=mf end)

            -- Blocky toggle track (rectangle)
            local Track = mk("Frame",{Size=dim2(0,28,0,14),Position=dim2(1,-30,0.5,-7),
            ...
            -- Blocky square thumb
            local Ball = mk("Frame",{Size=dim2(0,10,0,10),
                Position=val and dim2(0,16,0.5,-5) or dim2(0,2,0.5,-5),
                BackgroundColor3=C.White,BorderSizePixel=0,Parent=Track})

            local function set(v, silent)
                val=v
                tw(Track,{BackgroundColor3=v and AC or C.Toggle},0.1)
                tw(Ball, {Position=v and dim2(0,16,0.5,-5) or dim2(0,2,0.5,-5)},0.12)
        ...
        function CAT:_AddSlider(o5, parentOverride)
            ...
            local NmLbl = mk("TextLabel",{Size=dim2(0.6,0,1,0),BackgroundTransparency=1,Text=nm,
            ...
            -- Rectangular track (fully blocky)
            local Track = mk("Frame",{Size=dim2(1,-42,0,4),Position=dim2(0,0,0.5,-2),
            ...
            regFill(Fill)
            -- Blocky rectangular thumb (NOT a circle)
            local Knob = mk("Frame",{Size=dim2(0,6,0,14),Position=dim2(pct,-3,0.5,-7),
                BackgroundColor3=C.White,BorderSizePixel=0,Parent=Track})
        ...
        function CAT:_AddDropdown(o5, parentOverride)
            ...
            onFont(function(mf,_) NmLbl.Font=mf end)
            local Hd = mk("TextButton",{Size=dim2(1,0,0,23),Position=dim2(0,0,0,15),
                BackgroundColor3=C.BgRow,Text="",AutoButtonColor=false,
                BorderSizePixel=0,Parent=wrap})
            local SelLbl = mk("TextLabel",{Size=dim2(1,-22,1,0),Position=dim2(0,5,0,0),
                BackgroundTransparency=1,Text=multi and "Select..." or tostring(sel),
                TextColor3=C.Tx1,TextSize=10,Font=Enum.Font.Gotham,
                TextXAlignment=Enum.TextXAlignment.Left,Parent=Hd})
            mk("TextLabel",{Size=dim2(0,14,1,0),Position=dim2(1,-16,0,0),
                BackgroundTransparency=1,Text="▾",TextColor3=C.Tx2,TextSize=10,
                Font=Enum.Font.Gotham,Parent=Hd})
            local isOpen=false
            ...
            local function buildDD(ov)
                ...
                local lh=math.min(#opts2*22+6,150)
                ...
                for _,op in ipairs(opts2) do
                    ...
                    local ob=mk("TextButton",{Size=dim2(1,0,0,22),Text=op,
                    ...
                    ob.MouseButton1Click:Connect(function()
                        if multi then
                            ...
                            pcall(cb,msel)
                        else sel=op; SelLbl.Text=op; pcall(cb,op); closeDD() end
                    end)
                end
            end
        ...
        function CAT:_AddKeybind(o5, parentOverride)
            ...
            local listen = false
            local row = mkRow(parent, 26)
            local NmLbl = mk("TextLabel",{Size=dim2(1,-92,1,0),BackgroundTransparency=1,Text=nm,
                TextColor3=C.Tx1,TextSize=11,Font=MenuFont,
                TextXAlignment=Enum.TextXAlignment.Left,Parent=row})
            onFont(function(mf,_) NmLbl.Font=mf end)
            local Kb = mk("TextButton",{Size=dim2(0,86,0,18),Position=dim2(1,-88,0.5,-9),
            ...
            UIS.InputBegan:Connect(function(i,gpe)
                ...
                elseif not listen and not gpe and key~=Enum.KeyCode.Unknown and (i.KeyCode==key or i.UserInputType==key) then
                    pcall(cb)
                end
            end)
        ...
        function CAT:_AddButton(o5, parentOverride)
            ...
            local cb     = o5.Callback or function() end
            local Btn = mk("TextButton",{Size=dim2(1,0,0,24),BackgroundColor3=C.BgGroupH,
            ...
            Btn.MouseLeave:Connect(function()    tw(Btn,{BackgroundColor3=C.BgGroupH,TextColor3=C.Tx1},0.08) end)
            Btn.MouseButton1Down:Connect(function() tw(Btn,{BackgroundColor3=AC,TextColor3=C.White},0.06) end)
            Btn.MouseButton1Up:Connect(function()   tw(Btn,{BackgroundColor3=C.BgRow,TextColor3=C.Tx0},0.1) end)
            Btn.MouseButton1Click:Connect(function()
                task.delay(0.14, function() tw(Btn,{BackgroundColor3=C.BgGroupH,TextColor3=C.Tx1},0.1) end)
                pcall(cb)
            end)
    ...
    local function buildSettings()
        ...
        local function stToggle(lbl, default, onChange)
            local row = mk("Frame",{Size=dim2(1,0,0,24),BackgroundTransparency=1,Parent=GenPanel})
            mk("TextLabel",{Size=dim2(1,-34,1,0),BackgroundTransparency=1,Text=lbl,
                TextColor3=C.Tx0,TextSize=10,Font=MenuFont,
                TextXAlignment=Enum.TextXAlignment.Left,Parent=row})
            local val   = default
            local Track = mk("Frame",{Size=dim2(0,28,0,14),Position=dim2(1,-30,0.5,-7),
                BackgroundColor3=val and AC or C.Toggle,BorderSizePixel=0,Parent=row})
            ...
            Hit.MouseButton1Click:Connect(function()
                val=not val
                tw(Track,{BackgroundColor3=val and AC or C.Toggle},0.1)
                tw(Ball, {Position=val and dim2(0,16,0.5,-5) or dim2(0,2,0.5,-5)},0.12)
                pcall(onChange,val)
            end)
        end
    ...
    -- ═══════════════════════════════════════════════════════════
    -- PLAYER LIST TAB (pinned after Settings)
    -- ═══════════════════════════════════════════════════════════
    local function buildPlayerList()
        local PlCat   = WO:AddCategory("Players")
        local PlPanel = PlCat:AddSubTab("Players")

        local useMeter = false
        local unitRow  = mk("Frame",{Size=dim2(1,0,0,22),BackgroundTransparency=1,Parent=PlPanel})
        mk("TextLabel",{Size=dim2(1,-80,1,0),BackgroundTransparency=1,Text="Distance Unit",
            TextColor3=C.Tx2,TextSize=9,Font=Enum.Font.Gotham,
            TextXAlignment=Enum.TextXAlignment.Left,Parent=unitRow})
        local unitBtn = mk("TextButton",{Size=dim2(0,72,1,0),Position=dim2(1,-74,0,0),
            ...
            Font=Enum.Font.GothamBold,AutoButtonColor=false,BorderSizePixel=0,Parent=unitRow})
        ...
        local function refreshPlayers()
            ...
            for _,p in ipairs(Players:GetPlayers()) do
                if not plRows[p.UserId] and p~=LP then
                    local row=mk("Frame",{Size=dim2(1,0,0,26),BackgroundColor3=C.BgRow,
                        BorderSizePixel=0,Parent=plScroll})
                    mk("ImageLabel",{Size=dim2(0,22,0,22),Position=dim2(0,2,0.5,-11),
                        ...
                        Parent=row})
                    mk("TextLabel",{Size=dim2(0.55,0,1,0),Position=dim2(0,28,0,0),
                        BackgroundTransparency=1,Text=p.Name,TextColor3=C.Tx1,
                        TextSize=9,Font=Enum.Font.GothamBold,
                        TextXAlignment=Enum.TextXAlignment.Left,
                        TextTruncate=Enum.TextTruncate.AtEnd,Parent=row})
                    local distLbl=mk("TextLabel",{Size=dim2(0.4,0,1,0),Position=dim2(0.58,0,0,0),
                        BackgroundTransparency=1,Text="?",TextColor3=C.TxSub,
                        TextSize=9,Font=Enum.Font.Code,
                        TextXAlignment=Enum.TextXAlignment.Right,Parent=row})
                    plRows[p.UserId]={frame=row,distLbl=distLbl,player=p}
                end
            end
        end
            ...
            pcall(function()
                ...
                for _,info in pairs(plRows) do
                    ...
                    if p and p.Parent then
                        ...
                        else info.distLbl.Text="N/A" end
                    end
                end
            end)
        end)
        ...
        Players.PlayerRemoving:Connect(function(p)
            ...
            if plRows[p.UserId] then
                pcall(function() plRows[p.UserId].frame:Destroy() end); plRows[p.UserId]=nil
            end
        end)
