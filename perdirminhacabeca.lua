...
function Peleccos:CreateWindow(o)
    ...
    local TabScroll = mk("ScrollingFrame", {
        Size=dim2(1,0,1,-224), Position=dim2(0,0,0,58),
    ...
    mk("Frame", {
        Size=dim2(1,-16,0,1), Position=dim2(0,8,1,-166),
        BackgroundColor3=C.Toggle, BorderSizePixel=0, Parent=Sidebar,
    })
    local PinnedScroll = mk("Frame", {
        Size=dim2(1,0,0,62), Position=dim2(0,0,1,-166),
    ...
    -- Executor label
    mk("TextLabel", {
        Size=dim2(1,-16,0,12), Position=dim2(0,8,0,47),
    ...
    local wKeyTime = mk("TextLabel", {
        Size=dim2(1,-16,0,12), Position=dim2(0,8,0,62),
        ...
        openOV(function(ov)
            ...
            local function refreshModes()
                for _, info in ipairs(modeBtns) do
                    ...
                    info.btn.TextColor3       = active and C.White or C.Tx0
                end
            end
    ...
    function WO:AddCategory(name, _pinned)
        ...
        -- Pinned tabs get explicit LayoutOrder so Players always appears above Settings
        if _pinned then _pinnedOrder = _pinnedOrder + 1; Btn.LayoutOrder = _pinnedOrder end
