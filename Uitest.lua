...
function Peleccos:CreateWindow(o)
    ...
    function WO:AddTab(o2)
        ...
        local TAB={
            _name=tname,_sbtn=sbtn,_slbl=slbl,_abar=abar,_ibox=ibox,
        ...
        local function activateTab()
            ...
            slbl.TextColor3=C.TxtOn; abar.Visible=true; ibox.BackgroundColor3=AC
            self._activeTab=TAB
        ...
        function TAB:AddSubTab(o3)
            ...
            function STAB:AddSection(o4)
                ...
                function S:AddDropdown(o5)
                    ...
                    regFont(sl,"body")
                    local ar=new("TextLabel",{Text="▾",Size=UDim2.new(0,18,1,0),Position=UDim2.new(1,-20,0,0),BackgroundTransparency=1,TextColor3=C.TxtOff,TextSize=13,Font=_FONTBOLD,ZIndex=8,Parent=hd})
                    regFont(ar,"bold")
                    local function build(ov)
                        ...
                        for _,op in pairs(opts) do
                            ...
                            ob.MouseButton1Click:Connect(function()
                                ...
                                else sel=op;sl.Text=op;cb(op);fire("Dropdown",nm,op);toast(o5);if flag then _G[flag]=op end;ar.Text="▾";open=false;closeOV() end
                            end)
                        end
                    end
                    hd.MouseButton1Click:Connect(function() open=not open;if open then tw(ar,{Rotation=180},.15);openOV(build) else tw(ar,{Rotation=0},.15);closeOV() end end)
    ...
    task.defer(function()
        ...
        local TabCfg = WO:AddTab({ Name = "Config", Icon = "rbxassetid://0" })
