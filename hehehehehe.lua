...
function Peleccos:CreateWindow(o)
    ...
    -- Watermark drag (only while GUI is open)
    do
        local _wmDrag, _wmDs, _wmSp = false, nil, nil
        local WmHit = mk("TextButton", {
            Size=dim2(1,0,1,0), BackgroundTransparency=1,
            Text="", BorderSizePixel=0, ZIndex=5, Parent=WatermarkFrame,
        })
        ...
        function CAT:_AddDropdown(o5, parentOverride)
            ...
            local function buildDD(ov)
                ...
                local pan = mk("Frame",{
                    ...
                    BackgroundColor3=rgb(16,19,22), BorderSizePixel=1,
                    ClipsDescendants=true, ZIndex=220, Parent=ov,
                })
                mk("UIStroke",{Color=rgb(36,42,48),Thickness=1,Parent=pan})
                tw(pan, {Size=dim2(0,pw,0,lh)}, 0.14, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
    ...
    do
        ...
        local _hudTarget = nil  -- current Player instance
        ...
        local HudHpBg = mk("Frame",{
            Size=dim2(1,-62,0,5), Position=dim2(0,56,0,22),
        ...
        local HudDist = mk("TextLabel",{
            Size=dim2(0.5,-4,0,11), Position=dim2(0,56,0,30),
        ...
        local _hudUseMeter = false  -- syncs with Players tab unit preference
        ...
        -- Expose unit toggle so Players tab can sync
