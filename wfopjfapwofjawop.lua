...
function Peleccos:CreateWindow(o)
    ...
    -- ── Separator row inside TabScroll (always appears just before pinned tabs)
    local _pinnedSepFr = mk("Frame",{
        Size=dim2(1,-16,0,10), BackgroundTransparency=1,
        LayoutOrder=9989, Parent=TabScroll,
    })
    mk("Frame",{
        Size=dim2(1,0,0,1), Position=dim2(0,0,0.5,0),
        BackgroundColor3=C.Toggle, BorderSizePixel=0, Parent=_pinnedSepFr,
    })
    ...
    function WO:AddCategory(name, _pinned)
        ...
        local function mkGroup(parent, title)
            local Card = mk("Frame",{Size=dim2(1,0,0,0),AutomaticSize=Enum.AutomaticSize.Y,
                BackgroundColor3=C.BgGroupH,BorderSizePixel=0,ClipsDescendants=true,Parent=parent})
            mk("UICorner",{CornerRadius=dim(0,4),Parent=Card})
            local GBar = mk("Frame",{Size=dim2(0,2,0,2000),BackgroundColor3=AC,BorderSizePixel=0,Parent=Card})
            ...
            mk("UISizeConstraint",{MinSize=Vector2.new(0,80),Parent=Body})
        ...
        function CAT:_AddButton(o5, parentOverride)
            ...
            local Btn = mk("TextButton",{Size=dim2(1,0,0,25),BackgroundColor3=C.BgGroupH,
                Text=nm,TextColor3=C.Tx1,TextSize=12,Font=MenuFont,
                TextXAlignment=Enum.TextXAlignment.Left,
    ...
    local function buildPlayerList()
        ...
        local function buildCard(p)
            ...
            local infoFr = mk("Frame",{Size=dim2(1,0,0,50),BackgroundTransparency=1,Parent=expPanel})
            padding(infoFr,3,6,0,6)
            local function infoLine(y,label,value)
                local lbl1=mk("TextLabel",{Size=dim2(0.44,0,0,12),Position=dim2(0,0,0,y),
                ...
                addStroke(lbl1)
                local lbl2=mk("TextLabel",{Size=dim2(0.56,0,0,12),Position=dim2(0.44,0,0,y),
            ...
            infoLine(20, "Acct Age:", ageDays)
            infoLine(36, "Premium:",  premium)
